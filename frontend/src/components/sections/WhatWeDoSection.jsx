...
export default function WhatWeDoSection() {
  ...
  return (
    <section id="method" className="py-10 sm:py-24 px-4 sm:px-6 relative z-10 bg-[var(--paper-2)]/60 border-y border-[var(--line)]">
      <div className="max-w-6xl mx-auto space-y-10 sm:space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-8 items-center">
          ...
          <div className="lg:col-span-5 rounded-3xl overflow-hidden shadow-xl border border-[var(--line)] relative group h-[260px] sm:h-[460px] bg-[var(--card-bg)]">
            <picture>
          ...
          {/* 8-Stage Cycle Grid (2-column on mobile for compact scrolling) */}
          <div className="lg:col-span-7 grid grid-cols-2 gap-2.5 sm:gap-3.5">
            {LEARNING_CYCLE_STAGES.map((cycle, idx) => (
              <div
                key={idx}
                className="p-3 sm:p-4 rounded-2xl bg-[var(--card-bg)] border border-[var(--line)] shadow-2xs space-y-1 relative"
              >
        ...
        <div className="p-5 sm:p-8 rounded-3xl bg-[var(--card-bg)] border border-[var(--line)] shadow-lg space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-3 text-xs sm:text-sm">
            {[
              ...
              <div key={idx} className="p-3 rounded-xl bg-[var(--paper-2)] border border-[var(--line)] flex items-start gap-2.5">
