...
const resources = {
  ar: {
    translation: {
      ...
      heroEyebrow: 'منهجية قائمة على المشاريع — من سن ٨ إلى ٤٠',
      heroTitle1: 'الاحتياج بييجي الأول',
      heroTitleHighlight: 'والمعرفة',
      heroTitle2: 'بعده.',
      heroDesc: 'في صانع، كل طالب بيبدأ بمشروع حقيقي مش بمنهج جامد. بيتعلم البرمجة، الإلكترونيات، والروبوتيكس، والذكاء الاصطناعي لأنه محتاجها فعلاً — وبيخلص مش بشهادة، لكن بمنتج عمله بإيده.',
  ...
  en: {
    translation: {
      ...
      heroEyebrow: 'Project-based learning — Ages 8 to 40',
